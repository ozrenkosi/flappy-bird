class Pipe {
  ...
  show() {
    ...
    rect(this.x, 0, this.pipeWidth, this.topHeight, 0, 0, 5, 5);
    rect(this.x, this.topHeight+this.spacingBetween, this.pipeWidth, height-this.topHeight-this.spacingBetween, 5, 5, 0, 0)
  }
}
